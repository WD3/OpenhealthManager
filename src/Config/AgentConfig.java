...
public interface AgentConfig {
	...
	/* System type */
	public static byte[] system_type = {(byte)0, (byte)128, (byte)0, (byte)0}; /*0x80000000 (agent=0) */
	...
	/*System id*/
	public static byte[] bloodpressure_system_id = "BloodpressureAgent".getBytes();
	public static byte[] oximeter_system_id = "OximeterAgent".getBytes();
	/*Functional Units*/
