...
public class DateDecoder {
	...
	public static int setCentury(Date date) { return (1900+date.getYear())/100; }
	public static int setYear(Date date) { return (1900+date.getYear())%100; }
	public static int setMonth(Date date) { return date.getMonth()+1; }
